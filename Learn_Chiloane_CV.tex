...
\tagline{Electrical \& Information Engineering Final Year Student}
...
%  \mailaddress{Barnato Hall, 1 Jan Smuts Avenue, Braamfontein, Johannesburg, 2000}
  \mailaddress{P O Box 12, Acornhoek, 1360}
  \email{chiloane.learn@gmail.com}
  \phone{+27(0)60 337 7944}
  \location {Acornhoek, Mpumalanga}
 %\location{New Delhi, India}
%  \homepage{marissamayr.tumblr.com/}
%  \twitter{@marissamayer}
\github{https://github.com/chiloanel}
...
\begin{itemize}
    ...
    \item Practical design and operation of electrical machines (AC/DC-DC converters, transformers, induction motors, relays); using Arduino for development projects.
...
\cvevent{}{University of the Witwatersrand}{2019}{}
\begin{itemize}
\item Top 15\%
\end{itemize}
...
\cvevent{Student Assistant}{}{Mar 2020 -- Present}{ Wits University, Johannesburg}
